...
class ReviewScheduler:
    ...
    def generate_review_plan(
        ...
        for day_offset in range(days):
            ...
            day_items = [
                ...
                if item.due_date.date() <= target_date
            ]
    ...
    def _calculate_due_date(
        ...
        if last_accessed:
            try:
                ...
                logger.debug("ReviewScheduler: parse last_accessed '%s' failed: %s", last_accessed, e)
        ...
        if created_at:
            try:
                ...
                logger.debug("ReviewScheduler: parse created_at '%s' failed: %s", created_at, e)
    ...
    def get_today_plan(self, max_items: int = 30) -> DailyPlan:
        ...
        return plans[0] if plans else DailyPlan(
