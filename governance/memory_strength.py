...
class MemoryStrengthEvaluator:
    ...
    def _calculate_recency(self, last_accessed: str | None, now: datetime) -> float:
        """计算新近性（距离上次访问的天数）"""
        ...
        try:
            ...
            logger.debug("MemoryStrength: parse last_accessed '%s' failed, using 365 days", last_accessed)
            return 365.0
...
# 全局实例
_evaluator: MemoryStrengthEvaluator | None = None
